...
@dataclass
class MoexAssetBookData(AssetBookData):
...
class EtlMoex(EtlOptions):
    ...
    def get_symbols_books_snapshot(self, asset_name: list[str] | str | None,
                                   request_timestamp: pd.Timestamp | None = None) -> MoexAssetBookData:
        ...
        if book_summary_df is None or book_summary_df.empty:
            return MoexAssetBookData(asset_name=asset_name, request_timestamp=request_timestamp, option=None,
        ...
        return MoexAssetBookData(asset_name=asset_name, request_timestamp=request_timestamp,
    ...
    def _save_timeframe_book_update(self, book_data: MoexAssetBookData):
        """ Save book data"""
